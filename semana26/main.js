...
var link = new DOM('.link')
link.on('click', function handleClick(e) {
    e.preventDefault()
    console.log('clicou')
    link.off('click', handleClick)
})

console.log('Elementos selecionados:', link.get())
console.log('link é filho de body?', link.get()[0].parentNode === document.body)